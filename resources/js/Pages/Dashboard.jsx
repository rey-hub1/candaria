            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                ...
                {auth.user.role === 'admin' ? (
                    ...
                    <>
                        ...
                        <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" className="bg-white overflow-hidden rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition duration-200 p-6 flex items-center gap-4 group">
