...
export default function Login({ status }) {
    ...
    return (
        <div className="min-h-screen flex bg-slate-50 font-sans overflow-x-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-tr from-primary-950 via-primary-800 to-secondary-700 overflow-hidden items-center justify-center p-12">
                {/* Decorative glowing blobs */}
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-primary-400/20 blur-[100px] pointer-events-none animate-pulse"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-secondary-400/20 blur-[120px] pointer-events-none animate-pulse" style={{ animationDelay: '2s' }}></div>
                ...
                <div className="relative z-10 max-w-lg text-white flex flex-col items-start space-y-8 opacity-0 animate-fade-in-left" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-white/20 shadow-lg">
                        <ApplicationLogo className="w-10 h-10 fill-current text-primary-300" />
                        <span className="font-bold text-xl tracking-wide bg-gradient-to-r from-white to-primary-200 bg-clip-text text-transparent">CANDARIA</span>
                    </div>

                    <div className="space-y-4">
                        <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight">
                            Manajemen Kantin <br/>
                            <span className="text-primary-400">Jauh Lebih Praktis.</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full pt-4">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl flex items-center space-x-3 hover:bg-white/10 transition duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-primary-200/60">Pencarian & Scan Instan</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl flex items-center space-x-3 hover:bg-white/10 transition duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-primary-200/60">Rekonsiliasi Otomatis</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl flex items-center space-x-3 hover:bg-white/10 transition duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-primary-200/60">Ekspor PDF & Excel</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl flex items-center space-x-3 hover:bg-white/10 transition duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-primary-200/60">Notifikasi Stok Menipis</p>
                            </div>
                        </div>
                    </div>

                    <div className="pt-8 border-t border-white/10 w-full text-primary-200/50 text-xs">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12 sm:px-12 lg:px-20 bg-slate-50 relative">
                ...
                <div className="lg:hidden absolute top-[-50px] left-[-50px] w-48 h-48 rounded-full bg-primary-500/10 blur-3xl pointer-events-none"></div>
                <div className="lg:hidden absolute bottom-[-50px] right-[-50px] w-48 h-48 rounded-full bg-secondary-500/10 blur-3xl pointer-events-none"></div>
                ...
                <div className="w-full max-w-md space-y-8 bg-white border border-slate-200/60 p-8 rounded-2xl shadow-xl shadow-slate-100/50 relative z-10 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                    <div className="flex flex-col items-center text-center space-y-3">
                        <div className="lg:hidden flex items-center justify-center p-3 bg-primary-50 rounded-2xl border border-primary-100 mb-2">
                    ...
                    {status && (
                        <div className="text-sm font-medium text-primary-600 bg-primary-50 p-4 rounded-xl border border-primary-200 animate-fadeIn">
                            {status}
                        </div>
                    )}
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary-500 transition duration-150">
                                ...
                                <TextInput
                                    ...
                                    name="login"
                                    value={data.login}
                                    className="block w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 text-slate-800 transition duration-150"
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <TextInput
                                    ...
                                    name="password"
                                    value={data.password}
                                    className="block w-full pl-11 pr-11 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 text-slate-800 transition duration-150"
                                ...
                                <button
                                    type="button"
                                    className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-primary-500 transition duration-150"
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                ...
                                className="text-sm text-primary-600 hover:text-primary-500 font-semibold focus:outline-none transition duration-150 hover:underline"
                            >
                                Lupa sandi?
                            </Link>
                        </div>
                    ...
                    <div className="pt-4 border-t border-slate-100 flex flex-col items-center justify-center space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2 justify-center">
                            ...
                            <button 
                                ...
                                className="px-2.5 py-1 text-[11px] font-medium text-secondary-700 bg-secondary-50 hover:bg-secondary-100 border border-secondary-200/50 rounded-lg transition"
                            >
                                Kasir
                            </button>
                            <button
