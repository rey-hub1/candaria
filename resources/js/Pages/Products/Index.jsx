                                ...
                                <div key={p.id} className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                                    ...
                                    <div className="flex gap-2 mt-3">
                                        <button onClick={() => openEditModal(p)}
                                            className="flex-1 py-1.5 bg-slate-100 hover:bg-emerald-50 hover:text-emerald-700 text-slate-700 font-bold text-xs rounded-lg transition flex items-center justify-center gap-1.5">
