            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-6 print:hidden flex items-center justify-between">
                    <Link
                        ...
                        className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-lg shadow-sm transition flex items-center gap-1.5"
                    >
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-lg shadow-sm transition flex items-center gap-1.5"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
