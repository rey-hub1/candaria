    ...
    return (
        <AuthenticatedLayout title="Monitoring Pesanan Marketplace">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                />
                <select value={filters.vendor_id} onChange={(e) => updateFilter('vendor_id', e.target.value)} className="rounded-lg border-slate-200 text-sm focus:border-primary-500 focus:ring-primary-500">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {data.map((order) => (
                                <tr key={order.id}>
                                    ...
                                    <td className="px-4 py-3 text-right font-semibold text-primary-600">{formatRupiah(order.total)}</td>
