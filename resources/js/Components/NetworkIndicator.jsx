    ...
    return (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 flex flex-col items-center gap-2 pointer-events-none w-full px-4 max-w-sm">
            ...
            {isOnline && showBackOnline && (
                <div className="bg-primary-600 text-white px-4 py-3 rounded-xl shadow-lg shadow-primary-600/30 border border-primary-500/50 flex items-start gap-3 w-full animate-fade-in-up">
                    <div className="mt-0.5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-5 h-5">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-primary-100 mt-0.5">Koneksi internet Anda telah kembali.</p>
                    </div>
                </div>
            )}
        </div>
