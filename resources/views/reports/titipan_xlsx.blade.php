<table>
    <thead>
        <tr>
            <th colspan="9" style="font-weight: bold; font-size: 14px; text-align: left;">Kantin Smekda</th>
        </tr>
        <tr>
            <th colspan="9" style="font-weight: bold; font-size: 12px; text-align: left;">Laporan Penjualan Barang Titipan Siswa</th>
        </tr>
        <tr>
            <th colspan="9" style="font-size: 10px; color: #555555; text-align: left;">
        ...
        <!-- Summaries -->
        <tr>
            <th colspan="3" style="font-weight: bold; background-color: #f1f5f9; border: 1px solid #cbd5e1;">Total Terjual</th>
        ...
        <tr>
            <td colspan="3" style="font-weight: bold; text-align: left; border: 1px solid #cbd5e1;">{{ number_format($summary->total_qty) }} Pcs</td>
    ...
    <tbody>
        @foreach($items as $index => $item)
            <tr>
                ...
                <td style="border: 1px solid #cbd5e1; text-align: left;">{{ $item->created_at->format('d/m/Y H:i') }}</td>
