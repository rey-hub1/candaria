...
test('admin can pay a seller', function () {
    $admin = User::factory()->admin()->create();
    $seller = createSeller();
    // Seed earnings ≥ amount (pencairan tidak boleh melebihi saldo unpaid).
    createSaleItem(createSiswaProduct($seller, 5000), 2); // profit_seller = 10000
...
test('payment creates cashbook credit entry', function () {
    $admin = User::factory()->admin()->create();
    $seller = createSeller();
    createSaleItem(createSiswaProduct($seller, 5000), 3); // profit_seller = 15000
...
test('payment cannot exceed unpaid balance', function () {
    $admin = User::factory()->admin()->create();
    $seller = createSeller();
    createSaleItem(createSiswaProduct($seller, 3000), 1); // profit_seller = 3000
